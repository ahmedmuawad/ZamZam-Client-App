...
class ConfigModel {
  ...
  late EcommerceLocationCoverage _ecommerceLocationCoverage;
  ...
  String? _country;
  DlivMangment? _deliveryManagement;
  ...
  ConfigModel(
    ...
    this._deliveryManagement = _deliveryManagement;
  }
  ...
  DlivMangment? get dliv => _deliveryManagement;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _deliveryManagement = json['delivery_management'] != null
        ? new DlivMangment.fromJson(json['delivery_management'])
        : null;
  }
...
class DlivMangment {
  ...
  DlivMangment.fromJson(Map<String, dynamic> json) {
    _status = json['status'];
