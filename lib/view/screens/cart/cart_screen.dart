...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool _isSelfPickupActive = Provider
        .of<SplashProvider>(context, listen: false)
        .configModel
        .selfPickup == 1;
    bool _kmWiseCharge = Provider
        .of<SplashProvider>(context, listen: false)
        .configModel
        .deliveryManagement
        .status == 1;
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: ResponsiveHelper.isMobilePhone() ? null : ResponsiveHelper
          .isDesktop(context) ? MainAppBar() : AppBarBase(),
      body: Center(
        child: _isLogged ? Consumer<ProfileProvider>(
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 10),
                                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                        Text(getTranslated('balance', context), style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                        Text(
