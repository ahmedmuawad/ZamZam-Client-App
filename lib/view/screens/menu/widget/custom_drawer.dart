  ...
  Widget _zoomAndSlideContent(Widget container, BuildContext context,
    ...
    switch (_state) {
      ...
      case DrawerState.opening:
        slidePercent = (widget.openCurve).transform(_percentOpen!);
        scalePercent = _scaleDownCurve.transform(_percentOpen!);
        break;
      case DrawerState.closing:
        slidePercent = (widget.closeCurve).transform(_percentOpen!);
    ...
    final slideAmount =
        (widget.slideWidth! - slide!) * slidePercent * _rtlSlide!;
