            ...
            itemBuilder: (context, index1) {
              return Column(
                children: [
                  ...
                  SizedBox(
                      height: 190,
                      child: category.subCategoryData[index1].products.length >
                          0 ? ListView.builder(
                        itemCount:
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                              ...
                              child: Container(
                                ...
                                Text(
                                  '${category.subCategoryData[index1]
                                      .products[index].capacity} ${category
                                      .subCategoryData[index1].products[index]
                                      .unit}',
                                ...
                                Container(
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        double _price =  category.subCategoryData[index1].products[index].price;
                                        int _stock = category.subCategoryData[index1].products[index].variations.length > 0
                                            ? category.subCategoryData[index1].products[index].variations[0].stock
                                            : category.subCategoryData[index1].products[index].totalStock;
                                        CartModel _cartModel = CartModel(
                                          category.subCategoryData[index1].products[index].id,
                                          category.subCategoryData[index1].products[index].image[0],
                                          category.subCategoryData[index1].products[index].name, _price,
                                          ...
                                          1, category.subCategoryData[index1].products[index].variations.length > 0
                                            ? category.subCategoryData[index1].products[index].variations[0]
                                            : null,
                                          (_price-PriceConverter.convertWithDiscount(context, _price,
                                              category.subCategoryData[index1].products[index].discount,
                                              category.subCategoryData[index1].products[index].discountType)),
                                          (_price-PriceConverter.convertWithDiscount(context, _price,
                                              category.subCategoryData[index1].products[index].tax,
                                              category.subCategoryData[index1].products[index].taxType)),
                                          category.subCategoryData[index1].products[index].capacity,
                                          category.subCategoryData[index1].products[index].unit, _stock,
                                        );
